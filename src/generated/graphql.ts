...
export type UpdateCampaignNodeMutation = { __typename?: 'Mutation', campaignNodeUpdate: { __typename: 'CampaignNode', id: string, title: string, description?: string | null, label: string, notes: Array<string>, width: number, height: number, position: { __typename?: 'Position', x: number, y: number } } };
...
export type CampaignQuery = { __typename?: 'Query', campaign: { __typename: 'Campaign', id: string, title: string, description?: string | null, owner: { __typename: 'User', id: string, name: string }, campaignNodes: Array<{ __typename: 'CampaignNode', id: string, title: string, description?: string | null, width: number, height: number, position: { __typename?: 'Position', x: number, y: number }, transitions: Array<{ __typename?: 'Transition', to: { __typename?: 'CampaignNode', id: string }, from: { __typename?: 'CampaignNode', id: string } }> }> } };
